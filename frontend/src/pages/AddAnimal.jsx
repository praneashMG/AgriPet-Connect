...
const AddAnimal = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(resData.message || 'Failed to list animal');
      }
  ...
  return (
    <div className="py-12 max-w-2xl mx-auto px-4">
      <div className="bg-white border border-gray-100 rounded-2xl p-8 shadow-xs">
        <h2 className="text-3xl font-extrabold text-gray-900 text-center mb-2">List an Animal</h2>
        <p className="text-sm text-gray-500 text-center mb-8">Enter the details of your animal to list it on the marketplace.</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={handleChange}
              placeholder="Provide a detailed description of the animal (health, vaccinations, history, etc.)"
              className="w-full px-4 py-3 rounded-xl bg-gray-50 border border-gray-200 focus:outline-hidden focus:ring-2 focus:ring-emerald-500 text-sm"
            ></textarea>
          </div>
